...
class InputFieldWidget extends StatelessWidget {
  const InputFieldWidget(
      ...
      this.readOnly = false,
      this.fillColor,
      this.cursorColor = AppColors.primary}); // Add cursorColor property
  ...
  final Color cursorColor; // Add cursorColor property
    ...
    return SizedBox(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        TextFormField(
          ...
          cursorColor: cursorColor, // Set the cursor color here
